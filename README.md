...
## Project status
v1 has shipped and is available via Nuget. Running against netstandard2.0, it has support for round-tripping to Google, Facebook, Microsoft and any generic OAuth2 service that returns a JWT.
